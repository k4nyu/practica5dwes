...
class ModeloProducto {
    ...
    function add(Producto $objeto){
        $consultaSql = "insert into $this->tabla values(:idproducto, :nombre, :descripcion, :precio, :iva, :imagen);";
        ...
        $arrayConsulta["imagen"] = $objeto->getImagen();
    ...
    function edit(Producto $objeto){        
        $consultaSql = "update $this->tabla set nombre=:nombre, precio=:precio, descripcion=:descripcion, precio=:precio, iva=:iva, imagen=:imagen where idproducto=:idproducto;";
        $arrayConsulta["idproducto"] = $objeto->getIdproducto();
        $arrayConsulta["nombre"] = $objeto->getNombre();
        $arrayConsulta["descripcion"] = $objeto->getDescripcion();
        $arrayConsulta["precio"] = $objeto->getPrecio();
    ...
    function editPK(Producto $objetoNuevo, $idproductopk){
        $consultaSql = "update $this->tabla set nombre=:nombre, precio=:precio, descripcion=:descripcion, precio=:precio, iva=:iva, imagen=:imagen where :idproducto=:idproductopk;";
        $arrayConsulta["idproducto"] = $objeto->getIdproducto();
        $arrayConsulta["nombre"] = $objeto->getNombre();
        $arrayConsulta["descripcion"] = $objeto->getDescripcion();
        $arrayConsulta["precio"] = $objeto->getPrecio();
